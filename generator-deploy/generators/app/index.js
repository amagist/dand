...
module.exports = class extends Generator {
  constructor(args, opts) {
    ...
    this.options.auth ? this.config.set("auth", true) : this.config.set("auth", false);
  }
  ...
  prompting() {
    ...
    if (this.config.get('auth')) {
      ...
      },
      {
        type: 'input',
        name: 'id',
        message: '(After creating an SSO config) What is your Client ID?'
      }, {
        type: 'input',
        name: 'secret',
        message: '(After creating an SSO config) What is your Client secret?'
      },
      {
        type: 'input',
        name: 'username',
